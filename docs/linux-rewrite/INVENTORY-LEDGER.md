...
| id | verdict | evidence | judged |
|---|---|---|---|
| `F-EDIT-01` | half-proven | Preview\|Code segmented switch drawn in the editor header, Preview active and Markdown genuinely rendered (`orch5-ctx-open.png`); the toggle click itself is unproven — that capture was lost to display contention. The P39 claim of a drawn switch is now confirmed | orchestrator drive, 2026-08-14 |
