...
> The `reference/probe.py` helper and the `reference/shots/` baseline captures this
> document walks through were dropped from the tree along with the rest of the
> pre-rename archive. They remain readable at commit `bbcf5ed93eac7f57da4d5ff5c057d79de37f8453`:
> `git show bbcf5ed93eac7f57da4d5ff5c057d79de37f8453:reference/probe.py`.
