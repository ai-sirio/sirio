...
use crate::installer::{UnpackKind, unpack_kind};
...
/// has. Supplied by the caller from `sirio_agents`, which this crate does
/// not depend on.
...
/// One agent installed and owned by Sirio.
...
/// Whether the id names one of Sirio's five built-in adapters.
...
mod tests {
    ...
    fn installed() -> InstalledAgent {
        InstalledAgent {
            ...
            executable: PathBuf::from("/data/sirio/agents/opencode/1.18.21/opencode"),
            args: vec!["acp".into()],
