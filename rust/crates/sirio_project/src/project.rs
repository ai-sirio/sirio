//! The [`Project`] value type: a root directory the user added to Sirio.

use std::path::PathBuf;

use crate::ProjectId;

/// A root directory the user added to Sirio.
///
/// A project is just a folder on disk — Sirio supports non-git projects
