...
//!
//! The contract mirrors the Swift app's `SirioGit` package:
//!
...
mod tests {
    ...
    fn sample_porcelain() -> &'static str {
        concat!(
            "worktree /Users/me/sirio\n",
            "HEAD 1638c08b4ffb127b9852cbab3124df6a374d07f7\n",
            "branch refs/heads/main\n",
            "\n",
            "worktree /Users/me/sirio-feature\n",
            "HEAD 1638c08b4ffb127b9852cbab3124df6a374d07f7\n",
            "branch refs/heads/feature/login\n",
            "\n",
            "worktree /Users/me/sirio-detached\n",
            "HEAD a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0\n",
            "detached\n",
            "\n",
            "worktree /Users/me/sirio-locked\n",
            "HEAD 1638c08b4ffb127b9852cbab3124df6a374d07f7\n",
            "branch refs/heads/locked-branch\n",
            "locked in use by backup\n",
            "\n",
            "worktree /Users/me/sirio-prunable\n",
            "HEAD 1638c08b4ffb127b9852cbab3124df6a374d07f7\n",
    ...
    fn parses_primary_linked_detached_locked_and_prunable_entries() {
        ...
        assert_eq!(worktrees[0].path, PathBuf::from("/Users/me/sirio"));
        ...
        assert_eq!(worktrees[1].path, PathBuf::from("/Users/me/sirio-feature"));
        ...
        assert_eq!(worktrees[2].path, PathBuf::from("/Users/me/sirio-detached"));
        ...
        assert_eq!(worktrees[3].path, PathBuf::from("/Users/me/sirio-locked"));
        ...
        assert_eq!(worktrees[4].path, PathBuf::from("/Users/me/sirio-prunable"));
