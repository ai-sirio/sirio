//! The [`Workspace`]: the whole tree Tiller manages, plus the pure tree
...
/// Tiller's scale (a handful of projects, each with a few worktrees).
...
mod tests {
    ...
    /// A workspace with one project ("tiller"), two worktrees ("main",
    ...
    fn seeded_workspace() -> Workspace {
        ...
        workspace.worktrees.push(Worktree::new(
            ...
            project_id(),
            "feature/login",
            PathBuf::from("/Users/me/tiller-feature"),
            false,
        ));
    ...
    fn empty_query_returns_the_whole_tree() {
        ...
        assert_eq!(project.project.name, "tiller");
    ...
    fn filter_is_case_insensitive() {
        ...
        let by_project = workspace.filter("TILLER");
    ...
    fn filter_drops_projects_with_no_match() {
        ...
        let filtered = workspace.filter("tiller");
        assert_eq!(filtered.projects.len(), 1);
        assert_eq!(filtered.projects[0].project.name, "tiller");
    ...
    fn load_project_fills_model_fields_for_a_git_repo() {
        ...
        let discovered = discovery::DiscoveredProject {
            ...
            worktrees: vec![
                DiscoveredWorktree {
                    path: PathBuf::from("/Users/me/tiller"),
                ...
                DiscoveredWorktree {
                    path: PathBuf::from("/Users/me/tiller-detached"),
