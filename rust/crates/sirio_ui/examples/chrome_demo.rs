...
use sirio_ui::sidebar::icons::SirioAssets;
use sirio_ui::{status_bar::StatusBar, tab_bar::TabBar, titlebar::Titlebar};
    ...
    application().with_assets(SirioAssets).run(|cx: &mut App| {
        ...
        cx.open_window(
            WindowOptions {
                ...
                // comet nor Sirio has OS-drawn lights available on Linux.
