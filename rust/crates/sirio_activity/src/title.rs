...
mod tests {
    ...
    fn pi_glyph_titles_identify_pi_and_omp() {
        ...
        assert_eq!(
            identify_agent_from_title(&format!("{} π - sirio", spinner())),
            Some("pi")
        );
        assert_eq!(
            identify_agent_from_title(&format!("{} π: sirio", spinner())),
    ...
    fn pi_spinner_is_running_and_bare_name_is_needs_input() {
        ...
        assert_eq!(
            detect_status_from_title("π - sirio", "pi"),
            Some(AgentStatus::NeedsInput)
        );
    ...
    fn omp_follows_pi_family_conventions() {
        assert_eq!(
            detect_status_from_title("π: sirio", "omp"),
            Some(AgentStatus::NeedsInput)
        );
        assert_eq!(
            detect_status_from_title(&format!("{} π: sirio", spinner()), "omp"),
            Some(AgentStatus::Running)
        );
