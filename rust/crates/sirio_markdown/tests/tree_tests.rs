...
//!
//! The streaming tests feed a document to [`sirio_markdown::parse`] one byte
...
use sirio_markdown::{Alignment, Block, Document, Inline, ListItem, ListKind, TableCell, parse};
